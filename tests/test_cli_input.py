...
from chasingclaw.cli import commands
...
def mock_prompt_session():
    ...
    with patch("chasingclaw.cli.commands._PROMPT_SESSION", mock_session):
        yield mock_session
...
def test_init_prompt_session_creates_session():
    ...
    with patch("chasingclaw.cli.commands.PromptSession") as MockSession, \
         patch("chasingclaw.cli.commands.FileHistory") as MockHistory, \
